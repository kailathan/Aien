...
public class Water : MonoBehaviour
{
    ...
    public int waterStart = -10;
    public int waterEnd= 60;
    public int depth = -10;
    ...
    {
        //Spawning our water
        SpawnWater(waterStart, waterEnd, surfaceLevel, depth);
    }
    ...
    public void SpawnWater(float Left, float Width, float Top, float Bottom)
    {
        ...
        //change the position of water spawner object to (0, 0)
        ...
        newVerticies.Add(new Vector2(Left, Top));
        newVerticies.Add(new Vector2(Width+Left, Top));

        EdgeCollider2D waterSurface =  gameObject.AddComponent<EdgeCollider2D>();
        waterSurface.isTrigger = true;
        waterSurface.points = newVerticies.ToArray();
        ...
        //Set water surface to be on first layer
        Body.sortingLayerName = "Foreground";
